...
$.each(foodItems, function (key, value) {
    foodHtml += '<section class="foodCard" ><img class="foodImg" src='
        ...
        + value.Discount + ' <span>₹</span></div></div><div class="prices"><i class="fa fa-tag" aria-hidden="true"></i> <div class="">' + value.FinalPrice + '<span>₹</span></div></div></section><div class="starholder"> <i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i></div></section></section>';
});
